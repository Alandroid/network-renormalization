...
# TODO: Both display modes should be called here
#if constants.DISPLAY_MODE == "multilayer":

    #### Code for plotting multi-layer

#elif constants.DISPLAY_MODE == "monolayer":

    #### Original code for this script